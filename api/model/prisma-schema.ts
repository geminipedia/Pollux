...
export const typeDefs = /* GraphQL */ `type Access {
  id: UUID!
  read: Boolean!
  write: Boolean!
  delete: Boolean!
...
input EventWhereInput {
  ...
  timemark: DateTime
  timemark_not: DateTime
  timemark_in: [DateTime!]
  timemark_not_in: [DateTime!]
  timemark_lt: DateTime
  timemark_lte: DateTime
  timemark_gt: DateTime
  timemark_gte: DateTime
  AND: [EventWhereInput!]
  OR: [EventWhereInput!]
  NOT: [EventWhereInput!]
}
...
input ItemCreateInput {
  ...
  statements: StatementCreateManyWithoutReferenceInput
  introduction: ParagraphCreateManyInput
  logs: LogCreateManyInput
  meta: Json
}

input ItemCreateOneWithoutStatementsInput {
  create: ItemCreateWithoutStatementsInput
  connect: ItemWhereUniqueInput
}

input ItemCreateWithoutStatementsInput {
  id: UUID
  itemId: String!
  name: String!
  i18n: i18nCreateManyInput
...
input ItemUpdateInput {
  ...
  statements: StatementUpdateManyWithoutReferenceInput
...
input ItemUpdateOneWithoutStatementsInput {
  create: ItemCreateWithoutStatementsInput
  update: ItemUpdateWithoutStatementsDataInput
  upsert: ItemUpsertWithoutStatementsInput
  delete: Boolean
  disconnect: Boolean
  connect: ItemWhereUniqueInput
}

input ItemUpdateWithoutStatementsDataInput {
  itemId: String
  name: String
  i18n: i18nUpdateManyInput
  images: ImageUpdateManyInput
...
input ItemUpsertWithoutStatementsInput {
  update: ItemUpdateWithoutStatementsDataInput!
  create: ItemCreateWithoutStatementsInput!
}
...
input StatementCreateInput {
  ...
  value: String!
  i18n: i18nCreateManyInput
  reference: ItemCreateOneWithoutStatementsInput
  meta: Json
}

input StatementCreateManyWithoutReferenceInput {
  create: [StatementCreateWithoutReferenceInput!]
  connect: [StatementWhereUniqueInput!]
}

input StatementCreateWithoutReferenceInput {
  id: UUID
  value: String!
  i18n: i18nCreateManyInput
  meta: Json
...
input StatementUpdateInput {
  value: String
  i18n: i18nUpdateManyInput
  reference: ItemUpdateOneWithoutStatementsInput
  meta: Json
}
...
input StatementUpdateManyWithoutReferenceInput {
  create: [StatementCreateWithoutReferenceInput!]
  delete: [StatementWhereUniqueInput!]
  connect: [StatementWhereUniqueInput!]
  set: [StatementWhereUniqueInput!]
  disconnect: [StatementWhereUniqueInput!]
  update: [StatementUpdateWithWhereUniqueWithoutReferenceInput!]
  upsert: [StatementUpsertWithWhereUniqueWithoutReferenceInput!]
...
input StatementUpdateWithoutReferenceDataInput {
  value: String
  i18n: i18nUpdateManyInput
  meta: Json
}

input StatementUpdateWithWhereUniqueWithoutReferenceInput {
  where: StatementWhereUniqueInput!
  data: StatementUpdateWithoutReferenceDataInput!
}

input StatementUpsertWithWhereUniqueWithoutReferenceInput {
  where: StatementWhereUniqueInput!
